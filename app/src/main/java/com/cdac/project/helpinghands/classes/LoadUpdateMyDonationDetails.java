...
/**
 * Created by parag on 21-07-2016.
 */
public class LoadUpdateMyDonationDetails extends AsyncTask<String,String,String> {

    private String lUrl;
    private Context mContext;
    public LoadUpdateMyDonationDetails(Context context, String url) {
        this.lUrl = url;
